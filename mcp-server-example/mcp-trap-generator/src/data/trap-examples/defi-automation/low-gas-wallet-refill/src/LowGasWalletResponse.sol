...
contract LowGasWalletResponse {
    ...
    event WalletRefilled(address indexed wallet, uint256 amount, uint256 timestamp);
     ...
     */
    function refillWallet(address wallet, uint256 amount) external onlyTrapConfig {
